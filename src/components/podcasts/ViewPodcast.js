    ...
    return (
      <div>
        <Row type="flex" justify="end">
          <Link to={`/contents/podcasts/${content._id}/edit`}>Edit</Link>
          ...
          <Divider type="vertical" />
          <Stat stat={124} icon="eye-o" tooltip="124 listens" />
          <Divider type="vertical" />
...
export default connect(mapStateToProps, mapDispatchToProps)(ViewPodcast);